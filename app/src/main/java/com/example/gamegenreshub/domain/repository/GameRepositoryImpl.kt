...
class GameRepositoryImpl @Inject constructor(
    ...
    override suspend fun getGamesByGenreId(genreIds: List<Int>): GamesByGenres {
        return genreClient.getGamesForGenres(genreIds.joinToString(","))
    }

    override suspend fun getGameDetails(id: Int): Games {
