...
class GenresFragment : BaseFragment() {
    ...
    private fun observeData() {
        genresAndGamesViewModel.genresObservable.observe(viewLifecycleOwner) { genres ->
        ...
        genresAndGamesViewModel.navigationEvent.observe(viewLifecycleOwner) {
            showGames(it)
        }
    }
